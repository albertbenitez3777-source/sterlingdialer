/*
# Fix: dialer_next_batch had a table alias bug in count query

The call count query referenced `c.provider_call_id` but the query
has no `c` alias — it should be just `provider_call_id`. This caused
the entire dialer_next_batch function to error out, stopping all calls.
*/
