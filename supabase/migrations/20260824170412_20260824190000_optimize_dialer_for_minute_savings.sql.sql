/*
# Reduce delete grace period from 3 minutes to 90 seconds
# With the new 45-second killStaleCalls timer, calls are either placed or killed much faster.
# The 90-second grace period is still enough for the dialer loop to place 12 calls.
*/
