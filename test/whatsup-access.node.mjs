...
const code=stripTypeScriptTypes(readFileSync(new URL('../supabase/functions/federal-one-v2/whatsup.ts',import.meta.url),'utf8')).replace('export async function','async function')+'; this.handler=whatsUp;';
